    ...
    {
//on change la couleur de l'input en rouge
        let controlcgu;
//on change la couleur de l'input en rouge
        let controlquestion;
//on change la couleur de l'input en rouge
        let controlmescommandes;
//si c'est null on affiche box alerte
        let controldate;
//on change la couleur de l'input en rouge
        let controlprenom;
//si c'est null on affiche box alerte
...
//on change la couleur de l'input en rouge
        let controlmail;
//début de recupération des données du Serveur_et_formulaires
        const nom = document.formulaire_contact.nom.value;
        const prenom = document.formulaire_contact.prenom.value;
        const date = document.formulaire_contact.date.value;
        const cp = document.formulaire_contact.cp.value;
        const adresse = document.formulaire_contact.adresse.value;
        const ville = document.formulaire_contact.ville.value;
        const mescommandes = document.formulaire_contact.mescommandes.value;
        const email = document.formulaire_contact.email.value;
        const cgu = document.querySelector('#cgu:checked');
        const question = document.formulaire_contact.question.value;

        //regex de contrôle des données
        const verif = /^[a-zA-Z0-9_.-]+@[a-zA-Z0-9-]{2,}[.][a-zA-Z]{2,4}$/;
        const ctrnom = /^[a-zA-Z]{2,}$/;
        const ctrprenom = /^[a-zA-Z]{2,}$/;
        const ctrcp = /^[0-9]{4,5}$/;
        const ctrdate = /^[0-9]{4,4}-[0-9]{2,2}-[0-9]{2,2}$/;
        const ctrquestion = /[a-zA-Z\d]{5}/;
        const ctradresse = /^[0-9]{1,}\s+[a-z]{2,}\s+[a-z]{2,}/;
        //au minimum 1 caractére car il existe la ville Y nom le plus court code postal 80190
        const ctrville = /^[a-zA-Z]{1,}$/;
        const testedate = date.split('-');
        const dateactuelle = new Date();
        const year = dateactuelle.getFullYear();
        const diffdate = year - 110;
        const dateenv = year - 15;
        let validy = false;//valeur par défaut
    ...
    if (verif.exec(email) == null)// si email ne contient pas des lettre point chiffre avant @ aprés arobase pareilhormis là le point est interdit etc
    {
        ...
        controlmail = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlmail = true;//on retourne true pour cette variable
    ...
    if (ctradresse.exec(adresse) == null)// on contrôle l'entré
    {
        ...
        controladresse = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controladresse = true;//on retourne true pour cette variable
    ...
    if (ctrville.exec(ville) == null)// on contrôle l'entré
    {
        ...
        controlville = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlville = true;//on retourne true pour cette variable
    ...
    if (ctrcp.exec(cp) == null)// si email ne contient pas des lettre point chiffre avant @ aprés arobase pareil hormis là le point est interdit etc
    {
        ...
        controlcp = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlcp = true;//on retourne true pour cette variable
    ...
    if (ctrnom.exec(nom) == null)//si nom ne contient pas au moins deux lettre on sait jamais monsieur wu sa existe :D
    {
        ...
        controlnom = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlnom = true;//on retourne true pour cette variable
    }
    ...
    if (ctrprenom.exec(prenom) == null)// si prenom ne contient pas au moins deux caractére alphabétique pareil on rejette
    {
        ...
        controlprenom = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlprenom = true;//on retourne true pour cette variable
    }
    ...
    if (ctrdate.exec(date) == null||validy==false)//si la date ne ressemble pas à 0000-00-00 c'est que ce n'est pas correcte c'est se que retourne type date dans l'input
    {
        ...
        controldate = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controldate = true;//on retourne true pour cette variable
    }
    ...
    if (mescommandes == "")// si commande c'est vide c'est à dire rien n'a était séléctionné
    {
        ...
        controlmescommandes = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlmescommandes = true; //on retourne true pour cette variable
    }
    ...
    if (ctrquestion.exec(question) == null)//si ya pas au moins 4 caractéres alpha numérique entré alors on refuse
    {
        ...
        controlquestion = false; //on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlquestion = true;//on retourne true pour cette variable
    }
        ...
        document.getElementById("cgu").className = "custom-control-input is-invalid";
            controlcgu = false;//on retourne false au form pour évité l'envoie du Serveur_et_formulaires
    ...
    else
    {
        ...
        controlcgu = true;//on retourne true pour cette variable
    }

        return controlcp && controlville && controladresse && controlnom && controlprenom && controlmail && controldate && controlmescommandes && controlquestion && controlcgu;
    })
